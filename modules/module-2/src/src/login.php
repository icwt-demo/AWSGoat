	...
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<div class="input-group">
				<input type="email" placeholder="Email" name="email" value="<?php echo htmlentities($email, ENT_QUOTES); ?>" required>
			</div>
			<div class="input-group">
				<input type="password" placeholder="Password" name="password" value="<?php echo htmlentities($_POST['password'], ENT_QUOTES); ?>" required>
			</div>
			<div class="input-group">
